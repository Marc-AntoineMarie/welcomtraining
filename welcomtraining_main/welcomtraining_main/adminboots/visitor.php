...
<head>
  ...
  <title>Admin Dashboard - Visiteurs</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] === 'add_user') {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['message'] = "Erreur lors de l'ajout du visiteur.";
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] === 'delete_user') {
    ...
    if ($stmt->execute()) {
        $_SESSION['message'] = "Visiteur supprimé avec succès.";
    } else {
        $_SESSION['message'] = "Erreur lors de la suppression du visiteur.";
    }
...
<div class="container mt-5">
  ...
  <!-- Tableaux pour les utilisateurs visiteurs -->
  ...
  <form method="POST" action="">
    ...
    <button type="submit" name="action" value="add_user" class="btn btn-primary">Ajouter Visiteur</button>
  </form>
</div>
